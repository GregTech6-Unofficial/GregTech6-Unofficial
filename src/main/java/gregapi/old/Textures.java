...
public class Textures {
	public enum BlockIcons implements IIconContainer, Runnable {
		...
		, FLUID_SPRING, GREG_O_LANTERN, FLUID_WELL
		...
		, SAPLING_SMALL_RUBBER  , SAPLING_SMALL_MAPLE   , SAPLING_SMALL_WILLOW  , SAPLING_SMALL_BLUEMAHOE   , SAPLING_SMALL_HAZEL   , SAPLING_SMALL_CINNAMON    , SAPLING_SMALL_RAINBOWOOD   , SAPLING_SMALL_COCONUT
		, SAPLING_LARGE_RUBBER  , SAPLING_LARGE_MAPLE   , SAPLING_LARGE_WILLOW  , SAPLING_LARGE_BLUEMAHOE   , SAPLING_LARGE_HAZEL   , SAPLING_LARGE_CINNAMON    , SAPLING_LARGE_RAINBOWOOD   , SAPLING_LARGE_COCONUT
		, LEAVES_RUBBER         , LEAVES_MAPLE          , LEAVES_WILLOW         , LEAVES_BLUEMAHOE          , LEAVES_HAZEL          , LEAVES_CINNAMON           , LEAVES_RAINBOWOOD          , LEAVES_COCONUT
		, LEAVES_OPAQUE_RUBBER  , LEAVES_OPAQUE_MAPLE   , LEAVES_OPAQUE_WILLOW  , LEAVES_OPAQUE_BLUEMAHOE   , LEAVES_OPAQUE_HAZEL   , LEAVES_OPAQUE_CINNAMON    , LEAVES_OPAQUE_RAINBOWOOD   , LEAVES_OPAQUE_COCONUT
		, PLANKS_RUBBER         , PLANKS_MAPLE          , PLANKS_WILLOW         , PLANKS_BLUEMAHOE          , PLANKS_HAZEL          , PLANKS_CINNAMON           , PLANKS_RAINBOWOOD          , PLANKS_COCONUT
		, LOG_SIDE_RUBBER       , LOG_SIDE_MAPLE        , LOG_SIDE_WILLOW       , LOG_SIDE_BLUEMAHOE        , LOG_SIDE_HAZEL        , LOG_SIDE_CINNAMON         , LOG_SIDE_RAINBOWOOD        , LOG_SIDE_COCONUT
		, LOG_TOP_RUBBER        , LOG_TOP_MAPLE         , LOG_TOP_WILLOW        , LOG_TOP_BLUEMAHOE         , LOG_TOP_HAZEL         , LOG_TOP_CINNAMON          , LOG_TOP_RAINBOWOOD         , LOG_TOP_COCONUT
		, BEAM_SIDE_RUBBER      , BEAM_SIDE_MAPLE       , BEAM_SIDE_WILLOW      , BEAM_SIDE_BLUEMAHOE       , BEAM_SIDE_HAZEL       , BEAM_SIDE_CINNAMON        , BEAM_SIDE_RAINBOWOOD       , BEAM_SIDE_COCONUT
		, BEAM_TOP_RUBBER       , BEAM_TOP_MAPLE        , BEAM_TOP_WILLOW       , BEAM_TOP_BLUEMAHOE        , BEAM_TOP_HAZEL        , BEAM_TOP_CINNAMON         , BEAM_TOP_RAINBOWOOD        , BEAM_TOP_COCONUT
