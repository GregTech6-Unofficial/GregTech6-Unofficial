...
public class MT {
	...
	static OreDictMaterial create       (int aID, String aNameOreDict) {if (aID >= 16000 || aID < 15000 && aID >= 10000) return null; OreDictMaterial rMaterial = OreDictMaterial.createMaterial(aID, aNameOreDict, aNameOreDict); ALL_MATERIALS_REGISTERED_HERE.add(rMaterial); return rMaterial;}
	...
	Li_6    = alkali        (   31, "Lithium-6"             , "Li-6"    ,   3,   3,   453,  1560,  0.534     , SET_ROUGH            , 230, 225, 255, 255).put(  G_INGOT_ORES                , FUSION                      ).aspects(TC.VITREUS, 1, TC.POTENTIA, 1, TC.RADIO, 1     ).put(TICKS_PER_SMELT*40, WASHING_MERCURY, MOLTEN),
	...
	Be_7    = alkaline      (   41, "Beryllium-7"           , "Be-7"    ,   4,   3,  1560,  2742,  1.85      , SET_METALLIC         , 110, 190, 110, 255).put(  G_INGOT_ORES                , FUSION                      ).aspects(TC.METALLUM, 2, TC.LUCRUM, 1, TC.RADIO, 1      ).put(MOLTEN),
	...
	Co      = transmetal    (  270, "Cobalt"                , "Co"      ,  27,  32,  1768,  3200,  8.86      , SET_METALLIC         ,  80,  80, 250, 255).put(  G_INGOT_ORES                , FUSION,UUM, COBALT_GROUP           ).aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1             ).qual(3,  5.0,  256, 3).put(WASHING_PERSULFATE, MORTAR, MAGNETIC_PASSIVE, MOLTEN),
	Co_60   = transmetal    (  278, "Cobalt-60"             , "Co-60"   ,  27,  43,  1768,  3200,  8.86      , SET_SHINY            ,  90,  90, 250, 255).put(  G_INGOT_ORES                , FUSION,COBALT_GROUP                ).aspects(TC.METALLUM, 1, TC.INSTRUMENTUM, 1, TC.RADIO, 1).qual(3,  5.0,  256, 3).put(WASHING_PERSULFATE, MORTAR, MAGNETIC_PASSIVE),
	Ni      = transmetal    (  280, "Nickel"                , "Ni"      ,  28,  30,  1728,  3186,  8.912     , SET_METALLIC         , 250, 250, 200, 255).put(  G_INGOT_ORES                , FUSION, UUM, NICKEL_GROUP           ).aspects(TC.METALLUM, 2, TC.IGNIS, 1                    ).qual(2,  6.0,   64, 2).put(WASHING_PERSULFATE, MORTAR, MAGNETIC_PASSIVE, MOLTEN),
	Cu      = noblemetal    (  290, "Copper"                , "Cu"      ,  29,  34,  1357,  2835,  8.96      , SET_SHINY            , 255, 100,   0, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, UUM, COPPER_GROUP           ).aspects(TC.METALLUM, 2, TC.PERMUTATIO, 1               ).qual(2,  4.0,   64, 0).put(WASHING_PERSULFATE, FURNACE, EXTRUDER_SIMPLE, MORTAR, MOLTEN, RAILS),
	Zn      = transmetal    (  300, "Zinc"                  , "Zn"      ,  30,  35,   692,  1180,  7.134     , SET_METALLIC         , 250, 240, 240, 255).put(  G_INGOT_ORES                , FUSION, UUM, ZINC_GROUP             ).aspects(TC.METALLUM, 2, TC.SANO, 1                     ).put(WASHING_PERSULFATE, WASHING_MERCURY, MOLTEN),
	Ga      = posttrans     (  310, "Gallium"               , "Ga"      ,  31,  39,   302,  2477,  5.907     , SET_DULL             , 220, 220, 255, 255).put(  G_INGOT_ORES                , FUSION, UUM, ICOSAGEN               ).aspects(TC.METALLUM, 2, TC.ELECTRUM, 1                 ).put(BRITTLE),
	Ge      = metalloid     (  320, "Germanium"             , "Ge"      ,  32,  40,  1211,  3106,  5.323     , SET_SHINY            , 212, 212, 212, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, UUM, CRYSTALLOGEN           ).aspects(TC.METALLUM, 2, TC.ELECTRUM, 1                 ).put(FURNACE, EXTRUDER_SIMPLE, MORTAR),
	As      = metalloid     (  330, "Arsenic"               , "As"      ,  33,  42,   887,  1090,  5.776     , SET_SHINY            , 103, 103,  86, 255).put(  G_INGOT_ORES                , FUSION, UUM, PNICTOGEN              ).aspects(TC.METALLUM, 1, TC.VENENUM, 2                  ).qual(2,  4.0,  128, 1),
	Se      = polyatomic    (  340, "Selenium"              , "Se"      ,  34,  45,   453,   958,  4.809     , SET_DULL             , 111,  20,  20, 255).put(  G_CRYSTAL_ORES              , FUSION, UUM, CHALCOGEN              ).aspects(TC.VITREUS, 1, TC.SPIRITUS, 2                  ).put(BRITTLE),
	Br      = diatomic      (  350, "Bromine"               , "Br"      ,  35,  45,   265,   332,  3.122     , SET_FLUID            ,  80,  10,  10, 255).put(  CONTAINERS_FLUID            , FUSION, UUM, HALOGEN                ).aspects(TC.METALLUM, 1, TC.AQUA, 1, TC.TEMPESTAS, 1    ).put(LIQUID),
	Kr      = noblegas      (  360, "Krypton"               , "Kr"      ,  36,  48,   115,   119,  0.003733  , SET_DIAMOND          , 128, 255, 128,  15).put(  CONTAINERS_GAS              , FUSION, UUM                         ).aspects(TC.AER, 3                                      ),
	Rb      = alkali        (  370, "Rubidium"              , "Rb"      ,  37,  48,   312,   961,  1.532     , SET_SHINY            , 240,  30,  30, 255).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects(TC.METALLUM, 2, TC.VITREUS, 1                  ),
	Sr      = alkaline      (  380, "Strontium"             , "Sr"      ,  38,  49,  1050,  1655,  2.64      , SET_METALLIC         , 200, 200, 200, 255).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects(TC.METALLUM, 2, TC.STRONTIO, 1                 ),
	Y       = transmetal    (  390, "Yttrium"               , "Y"       ,  39,  50,  1799,  3609,  4.469     , SET_METALLIC         , 220, 250, 220, 255).put(  G_INGOT_ORES                , FUSION, UUM, SCANDIUM_GROUP         ).aspects_met_rad(3, 0                                   ).put(MOLTEN),
	Zr      = refractmetal  (  400, "Zirconium"             , "Zr"      ,  40,  51,  2128,  4682,  6.506     , SET_DIAMOND          , 200, 255, 255, 127).put(  G_GEM_ORES_TRANSPARENT      , FUSION, UUM, TITANIUM_GROUP         ).aspects(TC.METALLUM, 2, TC.VITREUS, 1                  ).qual(3,  6.0,  512, 3).lens(DYE_INDEX_White).put(G_INGOT_ORES, CRYSTAL, VALUABLE),
	Nb      = refractmetal  (  410, "Niobium"               , "Nb"      ,  41,  53,  2750,  5017,  8.57      , SET_METALLIC         , 190, 180, 200, 255).put(  G_INGOT_ORES                , FUSION, UUM, VANADIUM_GROUP         ).aspects(TC.METALLUM, 2, TC.IGNIS, 1                    ),
	Mo      = refractmetal  (  420, "Molybdenum"            , "Mo"      ,  42,  53,  2896,  4912, 10.22      , SET_SHINY            , 180, 180, 220, 255).put(  G_INGOT_ORES                , FUSION, UUM, CHROMIUM_GROUP         ).aspects(TC.METALLUM, 2, TC.INSTRUMENTUM, 1             ).qual(3,  7.0,  512, 2).put(MOLTEN),
	Tc      = transmetal    (  430, "Technetium"            , "Tc"      ,  43,  55,  2430,  4538, 11.5       , SET_METALLIC         ,  66,  66,  99, 255).put(  G_INGOT_ORES                , FUSION, MANGANESE_GROUP             ).aspects_met_rad(2, 1                                   ).qual(3, 10.0, 1280, 1), Gregorium=Tc.put("Gregorium"),
	Ru      = platingroup   (  440, "Ruthenium"             , "Ru"      ,  44,  57,  2607,  4423, 12.37      , SET_SHINY            , 155, 155, 155, 255).put(  G_INGOT_ORES                , FUSION, UUM, IRON_GROUP             ).aspects_met_rad(3, 0                                   ).put(MOLTEN),
	Rh      = platingroup   (  450, "Rhodium"               , "Rh"      ,  45,  58,  2237,  3968, 12.41      , SET_SHINY            , 144, 144, 144, 255).put(  G_INGOT_ORES                , FUSION, UUM, COBALT_GROUP           ).aspects_met_rad(3, 0                                   ).put(MOLTEN),
	Pd      = platingroup   (  460, "Palladium"             , "Pd"      ,  46,  60,  1828,  3236, 12.02      , SET_SHINY            , 128, 128, 128, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, UUM, NICKEL_GROUP           ).aspects_met_rad(3, 0                                   ).qual(3,  8.0,  512, 2),
	Ag      = noblemetal    (  470, "Silver"                , "Ag"      ,  47,  60,  1234,  2435, 10.501     , SET_SHINY            , 220, 220, 255, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, UUM, COPPER_GROUP           ).aspects(TC.METALLUM, 2, TC.LUCRUM, 1                   ).qual(3, 10.0,   64, 2).put(RAILS, WASHING_MERCURY, MORTAR, MOLTEN, VALUABLE, ENDER_DRAGON_PROOF),
	Cd      = transmetal    (  480, "Cadmium"               , "Cd"      ,  48,  64,   594,  1040,  8.69      , SET_SHINY            ,  50,  50,  60, 255).put(  G_INGOT_ORES                , FUSION, UUM, ZINC_GROUP             ).aspects(TC.METALLUM, 1, TC.POTENTIA, 1, TC.VENENUM, 1  ),
	In      = posttrans     (  490, "Indium"                , "In"      ,  49,  65,   429,  2345,  7.31      , SET_SHINY            ,  64,   0, 128, 255).put(  G_INGOT_ORES                , FUSION, UUM, ICOSAGEN               ).aspects_met_rad(3, 0                                   ),
	Sn      = posttrans     (  500, "Tin"                   , "Sn"      ,  50,  68,   505,  2875,  7.287     , SET_DULL             , 220, 220, 220, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, UUM, CRYSTALLOGEN           ).aspects(TC.METALLUM, 2, TC.VITREUS, 1                  ).put(SOLDERING_MATERIAL, MOLTEN),
	Sb      = metalloid     (  510, "Antimony"              , "Sb"      ,  51,  70,   903,  1860,  6.685     , SET_SHINY            , 220, 220, 240, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, UUM, PNICTOGEN              ).aspects(TC.METALLUM, 2, TC.AQUA, 1                     ),
	Te      = metalloid     (  520, "Tellurium"             , "Te"      ,  52,  75,   722,  1261,  6.232     , SET_SHINY                                ).put(  G_INGOT_ORES                , FUSION, UUM, CHALCOGEN              ).aspects(TC.METALLUM, 2, TC.ELECTRUM, 1                 ),
	I       = diatomic      (  530, "Iodine"                , "I"       ,  53,  74,   386,   457,  4.93      , SET_DULL             , 255, 240, 240, 255).put(  G_CRYSTAL_ORES              , FUSION, UUM, HALOGEN                ).aspects(TC.VITREUS, 2, TC.TEMPESTAS, 1                 ),
	Xe      = noblegas      (  540, "Xenon"                 , "Xe"      ,  54,  77,   161,   165,  0.005887  , SET_DULL             ,   0, 255, 255,  15).put(  CONTAINERS_GAS              , FUSION, UUM                         ).aspects(TC.AER, 3                                      ),
	Cs      = alkali        (  550, "Caesium"               , "Cs"      ,  55,  77,   301,   944,  1.873     , SET_SHINY                                ).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects_met_rad(3, 0                                   ),
	Ba      = alkaline      (  560, "Barium"                , "Ba"      ,  56,  81,  1000,  2170,  3.594     , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects(TC.VINCULUM, 3                                 ),
	La      = lanthanide    (  570, "Lanthanum"             , "La"      ,  57,  81,  1193,  3737,  6.145     , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects_met_rad(3, 0                                   ).put("Lantanum"),
	Ce      = lanthanide    (  580, "Cerium"                , "Ce"      ,  58,  82,  1068,  3716,  6.77      , SET_SHINY            , 255, 255, 190, 255).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects_met_rad(3, 0                                   ),
	Pr      = lanthanide    (  590, "Praseodymium"          , "Pr"      ,  59,  81,  1208,  3793,  6.773     , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects_met_rad(3, 0                                   ),
	Nd      = lanthanide    (  600, "Neodymium"             , "Nd"      ,  60,  84,  1297,  3347,  7.007     , SET_SHINY            , 100, 100, 100, 255).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects(TC.METALLUM, 2, TC.MAGNETO, 2                  ).qual(3, 6.0, 512, 3).put(MAGNETIC_PASSIVE, MOLTEN),
	Pm      = lanthanide    (  610, "Promethium"            , "Pm"      ,  61,  83,  1315,  3273,  7.26      , SET_SHINY                                ).put(  G_INGOT_ORES                                              ).aspects_met_rad(1, 2                                   ),
	Sm      = lanthanide    (  620, "Samarium"              , "Sm"      ,  62,  88,  1345,  2067,  7.52      , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects_met_rad(3, 0                                   ),
	Eu      = lanthanide    (  630, "Europium"              , "Eu"      ,  63,  88,  1099,  1802,  5.243     , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects_met_rad(3, 0                                   ),
	Gd      = lanthanide    (  640, "Gadolinium"            , "Gd"      ,  64,  93,  1585,  3546,  7.895     , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects_met_rad(3, 0                                   ),
	Tb      = lanthanide    (  650, "Terbium"               , "Tb"      ,  65,  93,  1629,  3503,  8.229     , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects_met_rad(3, 0                                   ),
	Dy      = lanthanide    (  660, "Dysprosium"            , "Dy"      ,  66,  96,  1680,  2840,  8.55      , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects_met_rad(3, 0                                   ),
	Ho      = lanthanide    (  670, "Holmium"               , "Ho"      ,  67,  97,  1734,  2993,  8.795     , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects_met_rad(3, 0                                   ),
	Er      = lanthanide    (  680, "Erbium"                , "Er"      ,  68,  99,  1802,  3141,  9.066     , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects_met_rad(3, 0                                   ),
	Tm      = lanthanide    (  690, "Thulium"               , "Tm"      ,  69,  99,  1818,  2223,  9.321     , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM                         ).aspects_met_rad(3, 0                                   ),
	Yb      = lanthanide    (  700, "Ytterbium"             , "Yb"      ,  70, 103,  1097,  1469,  6.965     , SET_METALLIC         , 167, 167, 167, 255).put(  G_INGOT_ORES                , FUSION,  UUM                         ).aspects_met_rad(3, 0                                   ),
	Lu      = lanthanide    (  710, "Lutetium"              , "Lu"      ,  71, 103,  1925,  3675,  9.84      , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM, SCANDIUM_GROUP         ).aspects_met_rad(3, 0                                   ),
	Hf      = refractmetal  (  720, "Hafnium"               , "Hf"      ,  72, 106,  2506,  4876, 13.31      , SET_METALLIC         , 140, 140, 150, 255).put(  G_INGOT_ORES                , FUSION, UUM, TITANIUM_GROUP         ).aspects_met_rad(3, 0                                   ).put(FLAMMABLE, EXPLOSIVE, MOLTEN),
	Ta      = refractmetal  (  730, "Tantalum"              , "Ta"      ,  73, 107,  3290,  5731, 16.654     , SET_METALLIC         , 120, 120, 140, 255).put(  G_INGOT_ORES                , FUSION, UUM, VANADIUM_GROUP         ).aspects(TC.METALLUM, 2, TC.VINCULUM, 1                 ).put(MOLTEN),
	W       = refractmetal  (  740, "Tungsten"              , "W"       ,  74, 109,  3695,  5828, 19.25      , SET_METALLIC         ,  50,  50,  50, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, UUM, CHROMIUM_GROUP         ).aspects(TC.METALLUM, 3, TC.TUTAMEN, 1                  ).qual(3,  8.0, 5120, 3).put(MOLTEN, RAILS, "Wolframium", "Wolfram", "ElnTungsten"),
	Re      = precmetal     (  750, "Rhenium"               , "Re"      ,  75, 111,  3459,  5869, 21.02      , SET_SHINY            , 255, 255, 200, 255).put(  G_INGOT_ORES                , FUSION, UUM, MANGANESE_GROUP        ).aspects_met_rad(3, 0                                   ),
	Os      = platingroup   (  760, "OsmiumElemental"       , "Os"      ,  76, 114,  3306,  5285, 22.61      , SET_METALLIC         ,  50,  50, 255, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, UUM, IRON_GROUP             ).aspects(TC.METALLUM, 2, TC.MACHINA, 1, TC.NEBRISUM, 1  ).qual(3, 16.0, 1280, 4).put(MOLTEN, VALUABLE).setLocal("Osmium"),
	Ir      = platingroup   (  770, "Iridium"               , "Ir"      ,  77, 115,  2719,  4701, 22.56      , SET_DULL             , 240, 240, 245, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, UUM, COBALT_GROUP           ).aspects(TC.METALLUM, 2, TC.MACHINA, 1                  ).qual(3,  6.0, 5120, 4).put(MOLTEN, VALUABLE).setRGBaLiquid(255, 128, 200, 255),
	Pt      = platingroup   (  780, "Platinum"              , "Pt"      ,  78, 117,  2041,  4098, 21.46      , SET_SHINY            , 100, 180, 250, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, UUM, NICKEL_GROUP           ).aspects(TC.METALLUM, 2, TC.NEBRISUM, 1                 ).qual(3, 15.0, 64, 2).put(WASHING_MERCURY, RAILS, MORTAR, MOLTEN, VALUABLE),
	Au      = noblemetal    (  790, "Gold"                  , "Au"      ,  79, 117,  1337,  3129, 19.282     , SET_SHINY            , 255, 230,  80, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, UUM, COPPER_GROUP           ).aspects(TC.METALLUM, 2, TC.LUCRUM, 2                   ).qual(3, 12.5, 64, 2).put(WASHING_MERCURY, RAILS, MORTAR, MOLTEN, VALUABLE, WITHER_PROOF),
	Hg      = precmetal     (  800, "Mercury"               , "Hg"      ,  80, 120,   234,   629, 13.5336    , SET_SHINY            , 230, 220, 220, 255).put(  G_INGOT_ORES                , FUSION, UUM, ZINC_GROUP             ).aspects(TC.METALLUM, 1, TC.AQUA, 1, TC.VENENUM, 1      ).put("Quicksilver", "QuickSilver"),
	Tl      = posttrans     (  810, "Thallium"              , "Tl"      ,  81, 123,   577,  1746, 11.85      , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, UUM, ICOSAGEN               ).aspects_met_rad(3, 0                                   ),
	Pb      = posttrans     (  820, "Lead"                  , "Pb"      ,  82, 125,   600,  2022, 11.342     , SET_DULL             ,  60,  40, 110, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, UUM, CRYSTALLOGEN           ).aspects(TC.METALLUM, 2, TC.ORDO, 1                     ).qual(2,  8.0, 64, 1).put(SOLDERING_MATERIAL, SOLDERING_MATERIAL_BAD, MOLTEN),
	Bi      = posttrans     (  830, "Bismuth"               , "Bi"      ,  83, 125,   544,  1837,  9.807     , SET_METALLIC         , 100, 160, 160, 255).put(  G_INGOT_MACHINE_ORES        , FUSION, PNICTOGEN                   ).aspects(TC.METALLUM, 2, TC.MAGNETO, 1                  ).qual(2,  6.0, 64, 1).put(MAGNETIC_PASSIVE, MOLTEN),
	Po      = posttrans     (  840, "Polonium"              , "Po"      ,  84, 124,   527,  1235,  9.32      , SET_METALLIC                             ).put(  G_INGOT_ORES                , FUSION, CHALCOGEN                   ).aspects_met_rad(2, 1                                   ),
	At      = metalloid     (  850, "Astatine"              , "At"      ,  85, 124,   575,   610,  7.0       , SET_METALLIC         ,  33,  33,  33, 255).put( FUSION, G_INGOT_ORES, CONTAINERS_GAS, HALOGEN                     ).aspects(TC.POTENTIA, 2, TC.RADIO, 1                    ).put(GASSES),
	Rn      = noblegas      (  860, "Radon"                 , "Rn"      ,  86, 134,   202,   211,  0.00973   , SET_DULL             , 255,   0, 255,  15).put( FUSION,  CONTAINERS_GAS                                            ).aspects(TC.AER, 2, TC.RADIO, 1                         ),
	Fr      = alkali        (  870, "Francium"              , "Fr"      ,  87, 134,   300,   950,  1.87      , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ),
	Ra      = alkaline      (  880, "Radium"                , "Ra"      ,  88, 136,   973,  2010,  5.5       , SET_METALLIC         , 255, 255, 205, 255).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ),
	Ac      = actinide      (  890, "Actinium"              , "Ac"      ,  89, 136,  1323,  3471, 10.07      , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ),
	Th      = actinide      (  900, "Thorium"               , "Th"      ,  90, 142,  2115,  5061, 11.72      , SET_SHINY            ,   0,  30,   0, 255).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ).qual(3, 6.0, 512, 2),
	Pa      = actinide      (  910, "Protactinium"          , "Pa"      ,  91, 138,  1841,  4300, 15.37      , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ),
	...
	Np      = actinide      (  930, "Neptunium"             , "Np"      ,  93, 144,   917,  4273, 20.45      , SET_DULL                                 ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ),
	Pu      = actinide      (  940, "Plutonium"             , "Pu"      ,  94, 150,   912,  3501, 19.84      , SET_METALLIC         , 240,  50,  50, 255).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ).qual(3, 6.0, 512, 3).put(MOLTEN, "Plutonium244"),
	Pu_241  = actinide      (  943, "Plutonium-241"         , "Pu-241"  ,  94, 147,   912,  3501, 19.84      , SET_SHINY            , 245,  70,  70, 255).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(1, 3                                   ).qual(3, 6.0, 512, 3).put(MOLTEN),
	Pu_243  = actinide      (  945, "Plutonium-243"         , "Pu-243"  ,  94, 149,   912,  3501, 19.84      , SET_SHINY            , 250,  70,  70, 255).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(1, 2                                   ).qual(3, 6.0, 512, 3).put(MOLTEN),
	...
	Am      = actinide      (  950, "Americium"             , "Am"      ,  95, 150,  1449,  2880, 13.69      , SET_METALLIC         , 200, 200, 200, 255).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ).qual(3, 4.0, 256, 2).put(MOLTEN),
	Am_241  = actinide      (  951, "Americium-241"         , "Am-241"  ,  95, 146,  1449,  2880, 13.69      , SET_SHINY            , 210, 210, 210, 255).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(1, 3                                   ).qual(3, 4.0, 256, 2).put(MOLTEN),
	Cm      = actinide      (  960, "Curium"                , "Cm"      ,  96, 153,  1613,  3383, 13.51      , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ),
	Bk      = actinide      (  970, "Berkelium"             , "Bk"      ,  97, 152,  1259,  2900, 14.79      , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ),
	Cf      = actinide      (  980, "Californium"           , "Cf"      ,  98, 153,  1173,  1743, 15.1       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ),
	Es      = actinide      (  990, "Einsteinium"           , "Es"      ,  99, 153,  1133,  1269,  8.84      , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ),
	Fm      = actinide      ( 1000, "Fermium"               , "Fm"      , 100, 157,  1125, 3000 ,           0, SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(1, 2                                   ),
	Md      = actinide      ( 1010, "Mendelevium"           , "Md"      , 101, 157,  1100, 3000 ,           0, SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(1, 2                                   ),
	No      = actinide      ( 1020, "Nobelium"              , "No"      , 102, 157,  1100, 3000 ,           0, SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(1, 2                                   ),
	Lr      = actinide      ( 1030, "Lawrencium"            , "Lr"      , 103, 159,  1900, 3000 ,           0, SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , SCANDIUM_GROUP              ).aspects_met_rad(1, 2                                   ),
	Rf      = transmetal    ( 1040, "Rutherfordium"         , "Rf"      , 104, 161,  2400,  5800, 23.2       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , TITANIUM_GROUP              ).aspects_met_rad(1, 2                                   ),
	Db      = transmetal    ( 1050, "Dubnium"               , "Db"      , 105, 163, 1000 , 3000 , 29.3       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , VANADIUM_GROUP              ).aspects_met_rad(1, 2                                   ),
	Sg      = transmetal    ( 1060, "Seaborgium"            , "Sg"      , 106, 165, 1000 , 3000 , 35.0       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , CHROMIUM_GROUP              ).aspects_met_rad(1, 2                                   ),
	Bh      = transmetal    ( 1070, "Bohrium"               , "Bh"      , 107, 163, 1000 , 3000 , 37.1       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , MANGANESE_GROUP             ).aspects_met_rad(1, 2                                   ),
	Hs      = transmetal    ( 1080, "Hassium"               , "Hs"      , 108, 169, 1000 , 3000 , 40.7       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , IRON_GROUP                  ).aspects_met_rad(1, 2                                   ),
	Mt      = element       ( 1090, "Meitnerium"            , "Mt"      , 109, 167, 1000 , 3000 , 37.4       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , COBALT_GROUP                ).aspects_met_rad(1, 2                                   ),
	Ds      = element       ( 1100, "Darmstadtium"          , "Ds"      , 110, 171, 1000 , 3000 , 34.8       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , NICKEL_GROUP                ).aspects_met_rad(1, 2                                   ),
	Rg      = element       ( 1110, "Roentgenium"           , "Rg"      , 111, 169, 1000 , 3000 , 28.7       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , COPPER_GROUP                ).aspects_met_rad(1, 2                                   ),
	Cn      = transmetal    ( 1120, "Copernicium"           , "Cn"      , 112, 173,  150 ,   357, 23.7       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , ZINC_GROUP                  ).aspects_met_rad(1, 2                                   ),
	Nh      = element       ( 1130, "Nihonium"              , "Nh"      , 113, 171,   700,  1400, 16.0       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , ICOSAGEN                    ).aspects_met_rad(1, 2                                   ),
	Fl      = posttrans     ( 1140, "Flerovium"             , "Fl"      , 114, 175,   340,   420, 14.0       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , CRYSTALLOGEN                ).aspects_met_rad(1, 3                                   ),
	Fl_298  = posttrans     ( 1148, "Flerovium-298"         , "Fl-298"  , 114, 184,   340,   420, 14.0       , SET_SHINY                                ).put( FUSION,  G_INGOT_ORES                , CRYSTALLOGEN                ).aspects_met_rad(1, 2                                   ),
	Mc      = element       ( 1150, "Moscovium"             , "Mc"      , 115, 174,   700,  1400, 13.5       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , PNICTOGEN                   ).aspects_met_rad(1, 2                                   ),
	Lv      = element       ( 1160, "Livermorium"           , "Lv"      , 116, 177,   708,  1085, 12.9       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                , CHALCOGEN                   ).aspects_met_rad(1, 2                                   ),
	Fa      = element       ( 1170, "Farnsium"              , "Fa"      , 117, 177,   673,   823,  7.2       , SET_SHINY                                ).put( FUSION,  G_INGOT_ORES                , HALOGEN                     ).aspects_met_rad(1, 2                                   ).put("Tennessine"), Ts = Fa,
	Og      = element       ( 1180, "Oganesson"             , "Og"      , 118, 176,   258,   263,  5.0       , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(1, 2                                   ),
	Uue     = element       ( 1190, "Ununennium"            , "Uue"     , 119, 178,   290,   903,           0, SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(1, 2                                   ),
	Ubn     = element       ( 1200, "Unbinilium"            , "Ubn"     , 120, 180,   953,  1973,           0, SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(1, 2                                   ),

	// The following Data is in no way reliable, but it is there in case someone wants to use it.
	Tn      = element( 1250, "TritaniumElemental"    , "Tn"      , 125, 198, 1500, 2500, 25.0     , SET_DULL     ,  55, 155, 155, 255).put(FUSION, G_DUST_ORES, UUM, METAL, SMITHABLE, MELTING, MOLTEN, EXTRUDER, "Unbipentium").aspects(TC.METALLUM, 2, TC.TUTAMEN, 2, TC.VITREUS, 1).setLocal("Elemental Tritanium"), Ubp = Tn,
	Ke      = element( 1260, "Trinium"               , "Ke"      , 126, 192, 2645, 4523,  1.06874 , SET_METALLIC , 234, 234, 234, 255).put(FUSION, G_INGOT_MACHINE_ORES, UUM, METAL, SMITHABLE, MELTING, MOLTEN, EXTRUDER, "Unbihexium").aspects(TC.METALLUM, 3, TC.TUTAMEN, 1, TC.VITREUS, 1).qual(3, 12.0, 2560, 4), Ubh = Ke,
	Dn      = element( 1450, "DuraniumElemental"     , "Dn"      , 145, 190,  1200, 2100, 20.0, SET_DULL,  75, 175, 175, 255).put(FUSION, G_DUST_ORES, UUM, METAL, SMITHABLE, MELTING, MOLTEN, EXTRUDER, "Unquadpentium").aspects(TC.METALLUM, 2, TC.TUTAMEN, 1).setLocal("Elemental Duranium"), Uqp = Dn, // material refined from dolamide ore
	Vb      = element( 1520, "Vibranium"             , "Vb"      , 152, 266,  4852, 9415, 3.23978365, SET_EMERALD, 200, 128, 255, 100).put(FUSION, G_GEM_ORES_TRANSPARENT, UUM, VALUABLE, GLOWING, "Unpentbium").aspects(TC.VITREUS, 10, TC.SENSUS, 10).setPriorityPrefix(1).qual(3, 1000.0, 512, 15), Upb = Vb,

	Nq      = element( 1740, "Naquadah"              , "Nq"      , 174, 352, 1500, 3000, 21.0, SET_METALLIC  ,  50,  50,  50, 255).put(FUSION, G_INGOT_MACHINE_ORES, UUM, METAL, SMITHABLE, MELTING, MOLTEN, EXTRUDER, "Unseptquadium").aspects(TC.METALLUM, 3, TC.RADIO, 1, TC.NEBRISUM, 1).setRGBaLiquid(  0, 255,   0, 255).qual(3, 6.0, 1280, 4), Usq = Nq,
	Nq_528  = element( 1741, "Naquadah-Enriched"     , "Nq-528"  , 174, 354, 1500, 3000, 22.0, SET_METALLIC  ,  60,  60,  60, 255).put(FUSION, G_INGOT_ORES, METAL, SMITHABLE, MELTING, MOLTEN, EXTRUDER, EXPLOSIVE).aspects(TC.METALLUM, 3, TC.RADIO, 2, TC.NEBRISUM, 2).setRGBaLiquid( 64, 255,  64, 255).setLocal("Enriched Naquadah").qual(3, 6.0, 1280, 4),
	Nq_522  = element( 1742, "Naquadria"             , "Nq-522"  , 174, 348, 1500, 3000, 20.0, SET_SHINY     ,  30,  30,  30, 255).put(FUSION, G_INGOT_ORES, METAL, SMITHABLE, MELTING, MOLTEN, EXTRUDER, EXPLOSIVE).aspects(TC.METALLUM, 4, TC.RADIO, 3, TC.NEBRISUM, 3).setRGBaLiquid(128, 255, 128, 255).qual(3, 1.0, 512, 4),
	An      = element( 1850, "Abyssalnite"           , "An"      , 185, 396, 1500, 3000, 15.0, SET_METALLIC  ,  90,  40, 170, 255).qual(3, 8.0, 1600, 3).put(FUSION, G_INGOT_MACHINE_ORES, UUM, METAL, SMITHABLE, MELTING, MOLTEN, EXTRUDER, "Unoctpentium").aspects(TC.METALLUM, 3, TC.VACUOS, 2), Uop = An,
	Cor     = element( 1860, "Coralium"              , "Cor"     , 186, 400, 2000, 4000, 20.0, SET_RUBY      ,  20, 160, 110, 255).qual(3,12.0, 3200, 3).put(FUSION, G_INGOT_MACHINE_ORES, UUM, METAL, SMITHABLE, MELTING, MOLTEN, EXTRUDER, G_GEM_ORES, "Unocthexium", "LiquifiedCoralium").aspects(TC.METALLUM, 3, TC.PERDITIO, 2), Uoh = Cor,
	Dr      = element( 1870, "Dreadium"              , "Dr"      , 187, 405, 2500, 5000, 25.0, SET_METALLIC  , 170,   0,   0, 255).qual(3,16.0, 4800, 4).put(FUSION, G_INGOT_MACHINE_ORES, UUM, METAL, SMITHABLE, MELTING, MOLTEN, EXTRUDER, "Unoctseptium").aspects(TC.METALLUM, 3, TC.TENEBRAE, 2), Uos = Dr,
	Etx     = element( 1880, "Ethaxium"              , "Etx"     , 188, 410, 3000, 6000, 30.0, SET_METALLIC  , 160, 170, 150, 255).qual(3,20.0, 6400, 4).put(FUSION, G_INGOT_MACHINE_ORES, UUM, METAL, SMITHABLE, MELTING, MOLTEN, EXTRUDER, "Unoctoctium").aspects(TC.METALLUM, 3, TC.VITIUM, 2), Uoo = Etx,
	Atl     = element( 2210, "Atlarus"               , "Atl"     , 221, 575, 3276, 11524, 21.24625421, SET_METALLIC, 204, 179,   0, 255).qual(3,  4.0, 4480, 4).put(FUSION, G_INGOT_MACHINE_ORES, UUM, SMITHABLE, MELTING, MOLTEN, EXTRUDER, MAGICAL, "Bibiunium").aspects(TC.METALLUM, 2, TC.COGNITO, 1), Bbu = Atl, Atlarus = Atl,
	Ad      = element( 2220, "Adamantium"            , "Ad"      , 222, 580, 5225, 14528, 13.35624762, SET_SHINY   , 255, 255, 255, 255).qual(3, 10.0, 5120, 5).put(FUSION, G_INGOT_MACHINE_ORES, UUM, SMITHABLE, MELTING, MOLTEN, EXTRUDER, MAGICAL, MAGNETIC_PASSIVE, WITHER_PROOF, ENDER_DRAGON_PROOF, "Adamant", "Bibibium").aspects(TC.METALLUM, 10, TC.PRAECANTIO, 10), Bbb = Ad,
	Mcg     = element( 2390, "Mac-Guffium"           , "Mcg"     , 239, 665, 200,  1000,  3.122, SET_SHINY, 200,  50, 150, 255).put(FUSION, G_CONTAINERS, UUM, VALUABLE, GLOWING, LIGHTING, "Bitriennium").aspects(TC.ALIENIS, 8, TC.PERMUTATIO, 8, TC.SPIRITUS, 8, TC.AURAM, 8, TC.VITIUM, 8, TC.RADIO, 8, TC.MAGNETO, 8, TC.ELECTRUM, 8, TC.NEBRISUM, 8, TC.STRONTIO, 8), Bte = Mcg,
	Gt      = element( 3720, "Gravitonium"           , "Gt"      , 372,1330, 112, 1275, 1768.866761, SET_SHINY,   0,  50,   0, 255).put(FUSION, G_CONTAINERS, UUM, "Triseptbium").aspects(TC.TERRA, 10, TC.POTENTIA, 10), Tsb = Gt,
	Neutronium = element(3800,"Neutronium"           , "Nt"      , 0,     1, 3000, 100000, 100000, SET_SHINY, 255, 255, 255, 255).qual(3, 1000000000.0, 1000000000, 15).put(FUSION, MOLTEN, VALUABLE, UNBURNABLE, MAGICAL, WITHER_PROOF, ENDER_DRAGON_PROOF, GLOWING, LIGHTING, MAGNETIC_ACTIVE).aspects(TC.POTENTIA, 10, TC.NEBRISUM, 10, TC.PERMUTATIO, 10, TC.MAGNETO, 10, TC.PRAECANTIO, 10, TC.AURAM, 10),
	...
	Alumina                 = oredustdcmp   ( 8008, "Alumina"               , SET_METALLIC          , 248, 248, 255, 255).put(MELTING, INGOTS)                                                                                                                          .uumMcfg( 0, Al             , 2*U, O                , 3*U)                                                                                                  .heat(2345, 3250), Al2O3 = Alumina,
	...
	U238F4                  = dustdcmp      ( 9009, "Uranium-238 Tetrafluoride", SET_SHARDS         ,  86, 118, 105, 255).put(MELTING, MOLTEN)                                                                                                                          .setMcfg( 0, U_238          , 1*U, F                , 4*U)                                                                                                  .aspects(TC.RADIO, 1, TC.PERDITIO, 2).setPriorityPrefix(2).heat(1309, 1690),Polyethylene            = create        ( 9901, "Polyethylene"          , SET_FLUID             ,  90,  60, 140, 255).put(LIQUID, FLAMMABLE)                                                                                                                                                                                                                                                                                    .heat( 200,  400).aspects(TC.MORTUUS, 1, TC.POTENTIA, 1),
	...
	U235F6                  = gaschemdcmp   ( 9012, "Uranium-235 Hexafluoride"                      ,  66,  98,  85, 255).put(GASSES)                                                                                                                                   .setMcfg( 0, U_235          , 1*U, F                , 6*U)                                                                                                  .aspects(TC.RADIO, 1, TC.PERDITIO, 3).setPriorityPrefix(2).heat( 100,  329),CobaltHexahydrate       = dustcent      ( 8229, "Cobalt Hexahydrate"    , SET_ROUGH             ,  80,  80, 250, 255)                                                                                                                                               .uumMcfg( 0, Co             , 1*U, H2O              , 6*U)                                                                                                  ,
	...
	*/
	...
	Basalt                  = stonecent     ( 8505, "Basalt"                                        ,  30,  30,  20, 255)                                                                                                                                               .setMcfg( 0, Olivine        , 1*U, CaCO3            , 3*U, Flint            , 8*U, DarkAsh          , 4*U)                                                  .aspects(TC.TENEBRAE    , 1).qual(1, 3.0, 32, 2).heat(1673),
	...
	//15000-16000 For GregTech6-Unofficial//
	Nb2Ti3C4                = alloymachine  (15000, "Titanium Niobium Carbide"                      , 153, 153, 204     ).put(MOLTEN).qual(3, 16.0, 7680, 4)                                                                                                            .uumMcfg( 0, NiobiumTitanium               , 6*U, C                , 4*U)                                                                          .aspects(TC.METALLUM, 2, TC.GELUM, 2).heat(4196).alloyCentrifuge(),


	H3PO4                   = lqudaciddcmp  (15001, "Phosphoric Acid"                               , 255, 255,  61,     255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, H              , 3*U, P                , 1*U, O                , 4*U)                                                                          .heat( 200,  400), PhosphoricAcid = H3PO4,
	Naphtha                 = lquddcmp      (15002, "Naphtha"                                       , 255, 255, 102, 255).put(LIQUID, EXPLOSIVE, FLAMMABLE)                                                                                                                                                                                                                                                                         .heat( 100,  400).aspects(TC.MORTUUS, 1, TC.POTENTIA, 1),
    H_Ion                   = lquddcmp      (15003, "Ionized Hydrogen"                              , 255, 255, 102, 255).put(PLASMA).heat(1, 12),
    He_Ion                  = lquddcmp      (15004, "Ionized Helium"                                , 255, 255, 102, 255).put(PLASMA).heat(2, 8),


	PTFE                    = create        (15005, "Polytetrafluoroethylene", SET_DULL             , 250, 250, 250, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 2*U, F                , 4*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(423).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),
    PE                      = create        (15006, "Polyethylene"          , SET_DULL              , 200, 200, 200, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 1*U, H                , 2*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(423).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),
    PVC                     = create        (15007, "Polyvinylchloride"     , SET_DULL              , 144, 238, 144, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 2*U, H                , 3*U, Cl, 1*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(600).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),
    Epoxid                  = create        (15008, "Epoxid"                , SET_DULL              , 192, 255,  62, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 11*U, H                , 12*U, O, 3*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(423).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),


	Na2CrO4                 = dustdcmp      (15009, "Sodium Chromate"       , SET_DULL              , 255, 255,   0, 255).put(MORTAR, BLACKLISTED_SMELTER, APPROXIMATE).setMcfg( 0, Cr, 1*U, O, 4*U, Na, 2*U),
    Na2Cr2O7                = dustdcmp      (15010, "Sodium Dichromate"     , SET_DULL              , 255,  69,   0, 255).put(MORTAR, BLACKLISTED_SMELTER, APPROXIMATE).setMcfg( 0, Cr, 2*U, O, 7*U, Na, 2*U),
    Cr2O3                   = dustdcmp      (15011, "Chromium Oxide"        , SET_DULL              ,   0, 139,   0, 255).put(MORTAR, BLACKLISTED_SMELTER, APPROXIMATE).setMcfg( 0, Cr, 2*U, O, 3*U);

	//TODO: merge the rest of 6.13.00
	...
	public static class TECH {
		...
		static {
			...
			*/
			...
			OREMATS.Chromite                .addOreByProducts(MnO2                  , Cr                        , Mg                    , OREMATS.Bromargyrite  );
...
//      CassiteriteSand         = oredustelec   ( 9109, "Cassiterite Sand"          , SET_SAND              , 220, 220, 220, 255).put(MORTAR, FURNACE                                                           ).setSmelting(Sn, 3*U4)     .uumMcfg( 1, Sn             , 1*U, O                , 2*U)                                                                                                  .heat(3 * Sn.mMeltingPoint / 2),
		...
		Chromite                = oredustdcmp   ( 9113, "Chromite"                  , SET_METALLIC          ,  35,  20,  15, 255).put(MORTAR, MELTING, MOLTEN, MAGNETIC_PASSIVE                                 )                           .setMcfg( 0, Fe             , 1*U, Cr               , 2*U, O                , 4*U)                                                                          .qual(0, 1.0, 16, 0),
