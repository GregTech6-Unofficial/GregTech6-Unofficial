...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60, 255).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	...
	Ethene                  = create        (27002, "Ethene"                , SET_FLUID             ,  64,  40, 100, 255).put(LIQUID, EXPLOSIVE)                                                                                                                                                                                                                                                                                    .heat( 100,  200).aspects(TC.MORTUUS, 1, TC.POTENTIA, 1),
	Naphtha                 = create        (27003, "Naphtha"               , SET_FLUID             , 255, 255, 102, 255).put(LIQUID, EXPLOSIVE, FLAMMABLE)                                                                                                                                                                                                                                                                         .heat( 100,  200).aspects(TC.MORTUUS, 1, TC.POTENTIA, 1);
