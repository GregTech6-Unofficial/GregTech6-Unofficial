...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60, 255).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
    ...
    PTFE                    = create        (27006, "Polytetrafluoroethylene"               , SET_DULL              , 79, 79, 79, 155).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 2*U, F                , 4*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(423).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),
