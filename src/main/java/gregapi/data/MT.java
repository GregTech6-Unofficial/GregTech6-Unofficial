...
public class MT {
	...
	Th      = actinide      (  900, "Thorium"               , "Th"      ,  90, 140,  2115,  5061, 11.72      , SET_SHINY            ,   0,  30,   0, 255).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ).qual(3, 6.0, 512, 2),
	Pa      = actinide      (  910, "Protactinium"          , "Pa"      ,  91, 138,  1841,  4300, 15.37      , SET_METALLIC                             ).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ),
	U_238   = actinide      (  920, "Uranium"               , "U"       ,  92, 146,  1405,  4404, 18.95      , SET_METALLIC         ,  50, 240,  50, 255).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(2, 1                                   ).qual(3, 6.0, 512, 3).put(MOLTEN, "Uranium238", "Uran"), // No, I could not make a Variable named "U" here. That would collide with the Material Unit.
	U_235   = actinide      (  921, "Uranium-235"           , "U-235"   ,  92, 143,  1405,  4404, 18.95      , SET_SHINY            ,  70, 250,  70, 255).put( FUSION,  G_INGOT_ORES                                              ).aspects_met_rad(1, 2                                   ).qual(3, 6.0, 512, 3).put(MOLTEN, "UraniumEnriched"),
	...
	Polyethylene            = create        ( 9901, "Polyethylene"          , SET_FLUID             ,  90,  60, 140, 255).put(LIQUID, FLAMMABLE)                                                                                                                                                                                                                                                                                    .heat( 200,  400).aspects(TC.MORTUUS, 1, TC.POTENTIA, 1),
...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60, 255).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	...
	CosmicNeutronium        = setalmachine  ( 8800, "Cosmic Neutronium"                             ,  30,  10,  40, 255).qual(3,        50.0,    100000, 10).put(VALUABLE, UNBURNABLE, MAGICAL, WITHER_PROOF, ENDER_DRAGON_PROOF)                                                                                                                                                                                                  .aspects(TC.POTENTIA, 10, TC.NEBRISUM, 10, TC.RADIO, 10, TC.TENEBRAE, 10, TC.TERRA, 10).heat(100000).setDensity(295650000),
    ...
    PTFE                    = create        (27006, "Polytetrafluoroethylene"               , SET_DULL              , 250, 250, 250, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 2*U, F                , 4*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(423).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),
    PE                      = create        (27007, "Polyethylene"               , SET_DULL              , 200, 200, 200, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 1*U, H                , 2*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(423).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),
    PVC                     = create        (27008, "Polyvinylchloride"               , SET_DULL              , 144, 238, 144, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 2*U, H                , 3*U, Cl, 1*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(600).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),
    Epoxid                  = create        (27009, "Epoxid"               , SET_DULL              , 192, 255, 62, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 11*U, H                , 12*U, O, 3*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(423).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),
    Na2CrO4                 = dustdcmp      (27010, "Sodium Chromate", SET_DULL, 255, 255, 0, 255             ).put(MORTAR, BLACKLISTED_SMELTER, APPROXIMATE).setMcfg( 0, Cr, 1*U, O, 4*U, Na, 2*U),
    Na2Cr2O7                = dustdcmp      (27011, "Sodium Dichromate", SET_DULL, 255, 69, 0, 255             ).put(MORTAR, BLACKLISTED_SMELTER, APPROXIMATE).setMcfg( 0, Cr, 2*U, O, 7*U, Na, 2*U),
    Cr2O3                   = dustdcmp      (27012, "Chromium Oxide", SET_DULL, 0, 139, 0, 255             ).put(MORTAR, BLACKLISTED_SMELTER, APPROXIMATE).setMcfg( 0, Cr, 2*U, O, 3*U);
