...
public class MT {
	...
	static OreDictMaterial create       (int aID, String aNameOreDict) {if (aID >= 20000) return null; OreDictMaterial rMaterial = OreDictMaterial.createMaterial(aID, aNameOreDict, aNameOreDict); ALL_MATERIALS_REGISTERED_HERE.add(rMaterial); return rMaterial;}
	...
	*/
	...
	Nb2Ti3C4                = alloymachine  (10000, "Titanium Niobium Carbide"                      , 153, 153, 204     ).put(MOLTEN).qual(3, 16.0, 7680, 4)                                                                                                            .uumMcfg( 0, NiobiumTitanium               , 6*U, C                , 4*U)                                                                          .aspects(TC.METALLUM, 2, TC.GELUM, 2).heat(4196).alloyCentrifuge(),


	H3PO4                   = lqudaciddcmp  (10001, "Phosphoric Acid"                               , 255, 255,  61,     255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, H              , 3*U, P                , 1*U, O                , 4*U)                                                                          .heat( 200,  400), PhosphoricAcid = H3PO4,
	Naphtha                 = lquddcmp      (10002, "Naphtha"                                       , 255, 255, 102, 255).put(LIQUID, EXPLOSIVE, FLAMMABLE)                                                                                                                                                                                                                                                                         .heat( 100,  400).aspects(TC.MORTUUS, 1, TC.POTENTIA, 1),
    H_Ion                   = lquddcmp      (10003, "Ionized Hydrogen"                              , 255, 255, 102, 255).put(PLASMA).heat(1, 12),
    He_Ion                  = lquddcmp      (10004, "Ionized Helium"                                , 255, 255, 102, 255).put(PLASMA).heat(2, 8),


	PTFE                    = create        (10005, "Polytetrafluoroethylene", SET_DULL             , 250, 250, 250, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 2*U, F                , 4*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(423).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),
    PE                      = create        (10006, "Polyethylene"          , SET_DULL              , 200, 200, 200, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 1*U, H                , 2*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(423).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),
    PVC                     = create        (10007, "Polyvinylchloride"     , SET_DULL              , 144, 238, 144, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 2*U, H                , 3*U, Cl, 1*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(600).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),
    Epoxid                  = create        (10008, "Epoxid"                , SET_DULL              , 192, 255,  62, 255).put(G_INGOT_MACHINE, APPROXIMATE, FLAMMABLE, EXTRUDER, EXTRUDER_SIMPLE, WIRES, MORTAR, BOUNCY, BRITTLE, FURNACE)                      .uumMcfg( 0, C              , 11*U, H                , 12*U, O, 3*U)                                                                                                  .aspects(TC.MOTUS, 2).heat(423).setBurning(Ash, U9).setSmelting(null, 2*U3).qual(1, 3.0, 32, 1),


	Na2CrO4                 = dustdcmp      (10009, "Sodium Chromate"       , SET_DULL              , 255, 255,   0, 255).put(MORTAR, BLACKLISTED_SMELTER, APPROXIMATE).setMcfg( 0, Cr, 1*U, O, 4*U, Na, 2*U),
    Na2Cr2O7                = dustdcmp      (10010, "Sodium Dichromate"     , SET_DULL              , 255,  69,   0, 255).put(MORTAR, BLACKLISTED_SMELTER, APPROXIMATE).setMcfg( 0, Cr, 2*U, O, 7*U, Na, 2*U),
    Cr2O3                   = dustdcmp      (10011, "Chromium Oxide"        , SET_DULL              ,   0, 139,   0, 255).put(MORTAR, BLACKLISTED_SMELTER, APPROXIMATE).setMcfg( 0, Cr, 2*U, O, 3*U);
