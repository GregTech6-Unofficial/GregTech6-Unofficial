...
public class MT {
	...
	*/
	...
	Nb2Ti3C4                = alloymachine  ( 9910, "Titanium Niobium Carbide"                      , 204, 153, 255, 255).put(MOLTEN).qual(3, 16.0, 7680, 4)                                                                                                            .uumMcfg( 0, Nb             , 3*U, Ti               , 3*U, C                , 4*U)                                                                          .aspects(TC.METALLUM, 2, TC.GELUM, 2).heat(4196).alloyCentrifuge(),
