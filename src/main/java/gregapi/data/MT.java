...
public class MT {
	...
	H3PO4                   = lqudaciddcmp  ( 9900, "Phosphoric Acid"       , SET_FLUID             , 255, 255,  61, 255).put(LIQUID)                                                                                                                                   .uumMcfg( 0, H              , 3*U, P                , 1*U, O                , 4*U)                                                                          .heat( 200,  400), PhosphoricAcid = H3PO4,
	...
	*/
	...
	Nb2Ti3C4                = alloymachine  ( 9910, "Titanium Niobium Carbide"                      , 153, 153, 204, 255).put(MOLTEN).qual(3, 16.0, 7680, 4)                                                                                                            .uumMcfg( 0, Nb             , 3*U, Ti               , 3*U, C                , 4*U)                                                                          .aspects(TC.METALLUM, 2, TC.GELUM, 2).heat(4196).alloyCentrifuge(),
