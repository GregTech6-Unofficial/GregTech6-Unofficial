...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60, 255).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                                      ,
	...
	NqU238Am                = oredustdcmp   (27006, "Naquadah Mixture"       , SET_METALLIC          , 55,  60, 50, 255).put(MELTING, MOLTEN, INGOTS)                                                                                                                   .uumMcfg( 1, Nq             , 1*U, Nq_528, 1*U,  U_238          ,2*U, Am, 1*U)                                                                                                  .qual(0, 1.0, 16, 20),
	UCl4                    = lqudacidcent  (27007, "Uranium Chloride"            , SET_FLUID        ,102, 204,  0, 255).put(LIQUID)                                                                                                                                    .uumMcfg( 0, U_238          , 1*U, Cl              , 4*U)                                                                                                  .heat( 200,  400),
	NqAm                    = lqudacidcent  (27008, "High Naquadah Chloride"            , SET_FLUID  ,  0,  26, 51, 255).put(LIQUID)                                                                                                                                    .uumMcfg( 0, Nq             , 1*U, Am              , 1*U, Nq_528, 1*U)                                                                                                  .heat( 200,  400);
