...
public class MT {
	...
	Be_7    = alkaline    (  41, "Beryllium-7"    , "Be-7"  ,   4,   3,  1560,  2742,  1.85      , SET_RAD     , 110, 190, 110     ,      FUSION                 , G_INGOT_ORES                                                                                    ).aspects(TC.METALLUM, 2, TC.LUCRUM, 1, TC.RADIO, 1      ).put(MOLTEN),
	...
	Y       = transmetal  ( 390, "Yttrium"        , "Y"     ,  39,  50,  1799,  3609,  4.469     , SET_METALLIC, 220, 250, 220, 255, UUM        , SCANDIUM_GROUP                                                                                                   ).aspects_met_rad(3, 0                                   ).put(MOLTEN),
