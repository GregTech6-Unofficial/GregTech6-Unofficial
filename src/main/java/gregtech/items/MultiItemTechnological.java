...
public class MultiItemTechnological extends MultiItemRandom {
	...
	public void addItems() {
		...
		CR.shaped(IL.Comp_Laser_Gas_Empty.get(1), CR.DEF_REV_NCC, "CWM", "WGx", "MTd", 'W', MT.DATA.CABLES_01[2], 'C', OD_CIRCUITS[1], 'M', OP.plate.dat(MT.Ag), 'T', OP.screw.dat(MT.StainlessSteel), 'G', Blocks.glass);
		...
		IL.Circuit_Plate_Empty_Epoxid.set(      addItem(tLastID = 30018, "Epoxid Circuit Plate"                     , "Needs Circuit Wiring"                            , new OreDictItemData(ANY.Cu, U, MT.GT6U.Epoxid, U), TC.stack(TC.FABRICO, 1)));
		IL.Circuit_Plate_Empty_Multilayer.set(  addItem(tLastID = 30019, "Multilayer Epoxid Circuit Plate"          , "Needs Circuit Wiring"                            , new OreDictItemData(ANY.Cu, U*2, MT.GT6U.Epoxid, U), TC.stack(TC.FABRICO, 1)));
		IL.Circuit_plate_Empty_Crystal.set(     addItem(tLastID = 30020, "Aluminium Printed Circuit Plate"          , "Needs Circuit Wiring"                            , new OreDictItemData(ANY.Cu, U*2, MT.GT6U.Epoxid, U*2), TC.stack(TC.FABRICO, 1)));
		IL.Perforated_Bushing.set(              addItem(tLastID = 30021, "Perforated Bushing"                       , "Used to manufacture glass fiber"                 , new OreDictItemData(ANY.Steel, U10*65), TC.stack(TC.FABRICO, 1)));
		...
		RM.Mixer.addRecipe1(T, 16, 300, ST.tag(0), FL.array(MT.HCl.fluid(U, T), MT.H2O2.fluid(U*2, T), MT.H2O.fluid(U*3, T)), MT.GT6U.ElectroEtchingSolution.fluid(U*6, T), NI);
		...
		RM.Press.addRecipeX(T, F, F, F, T, 16, 100, ST.array(OP.plate.mat(MT.GT6U.Epoxid, 1), IL.Glass_Fiber.get(4), OP.foil.mat(MT.Cu, 4)), IL.Circuit_Plate_Empty_Epoxid.get(1));
		RM.Press.addRecipeX(T, F, F, F, T, 16, 100, ST.array(OP.plate.mat(MT.GT6U.Epoxid, 1), OP.wireFine.mat(MT.Graphene, 4), OP.foil.mat(MT.Cu, 4)), IL.Circuit_Plate_Empty_Epoxid.get(1));

		RM.Press.addRecipeX(T, F, F, F, T, 16, 160, ST.array(OP.foil.mat(MT.GT6U.Epoxid, 4), IL.Glass_Fiber.get(8), OP.foil.mat(MT.Cu, 8)), IL.Circuit_Plate_Empty_Multilayer.get(1));
		RM.Press.addRecipeX(T, F, F, F, T, 16, 160, ST.array(OP.foil.mat(MT.GT6U.Epoxid, 4), OP.wireFine.mat(MT.Graphene, 8), OP.foil.mat(MT.Cu, 8)), IL.Circuit_Plate_Empty_Multilayer.get(1));

		RM.Press.addRecipeX(T, F, F, F, T, 64, 256, ST.array(OP.foil.mat(MT.GT6U.Epoxid, 8), OP.foil.mat(MT.Al, 4), IL.Glass_Fiber.get(16)), IL.Circuit_plate_Empty_Crystal.get(1));
		RM.Press.addRecipeX(T, F, F, F, T, 64, 256, ST.array(OP.foil.mat(MT.GT6U.Epoxid, 8), OP.foil.mat(MT.Al, 4), OP.wireFine.mat(MT.Graphene, 16)), IL.Circuit_plate_Empty_Crystal.get(1));
		...
		IL.Circuit_Plate_Copper.set(            addItem(tLastID = 30002, "Circuit Plate (Copper)"           , "Needs Circuit Parts"                             , new OreDictItemData(MT.Cu, U, ANY.SiO2, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.PERMUTATIO, 1)));
		...
		IL.Circuit_Plate_Magic.set(             addItem(tLastID = 30012, "Circuit Plate (Magic)"            , "Needs Circuit Parts"                             , new OreDictItemData(ANY.SiO2, U), TC.stack(TC.FABRICO, 1), TC.stack(TC.PRAECANTIO, 1)));
		...
		RM.Press.addRecipe2(T, F, F, F, T, 16, 64, IL.Circuit_Plate_Empty_Phenolic.get(1), IL.Circuit_Wire_Copper    .get(1), MT.GT6U.ElectroEtchingSolution.fluid(U10, T), NF, IL.Circuit_Plate_Copper    .get(1));
		RM.Press.addRecipe2(T, F, F, F, T, 16, 64, IL.Circuit_Plate_Empty.get(1), IL.Circuit_Wire_Copper    .get(1), MT.GT6U.ElectroEtchingSolution.fluid(U10, T), NF, IL.Circuit_Plate_Copper    .get(1));
		RM.Press.addRecipe2(T, F, F, F, T, 16, 64, IL.Circuit_Plate_Empty_Epoxid.get(1), IL.Circuit_Wire_Gold      .get(1), MT.GT6U.ElectroEtchingSolution.fluid(U10, T), NF,  IL.Circuit_Plate_Gold      .get(1));
		RM.Press.addRecipe2(T, F, F, F, T, 16, 64, IL.Circuit_Plate_Empty_Multilayer.get(1), IL.Circuit_Wire_Platinum  .get(1), MT.GT6U.ElectroEtchingSolution.fluid(U10, T), NF,  IL.Circuit_Plate_Platinum  .get(1));

		RM.Press.addRecipe2(T, F, F, F, T, 16, 64, IL.Circuit_Plate_Empty_Phenolic.get(1), IL.Circuit_Wire_Magic     .get(1), MT.GT6U.ElectroEtchingSolution.fluid(U10, T), NF, IL.Circuit_Plate_Magic     .get(1));
		RM.Press.addRecipe2(T, F, F, F, T, 16, 64, IL.Circuit_Plate_Empty.get(1), IL.Circuit_Wire_Magic     .get(1), MT.GT6U.ElectroEtchingSolution.fluid(U10, T), NF, IL.Circuit_Plate_Magic     .get(1));
		RM.Press.addRecipe2(T, F, F, F, T, 16, 64, IL.Circuit_Plate_Empty.get(1), IL.Circuit_Wire_Enderium  .get(1), MT.GT6U.ElectroEtchingSolution.fluid(U10, T), NF, IL.Circuit_Plate_Enderium  .get(1));
		RM.Press.addRecipe2(T, F, F, F, T, 16, 64, IL.Circuit_Plate_Empty.get(1), IL.Circuit_Wire_Signalum  .get(1), MT.GT6U.ElectroEtchingSolution.fluid(U10, T), NF, IL.Circuit_Plate_Signalum  .get(1));
		...
		RM.Assembler.addRecipeX(T, F, F, F, T,  32, 16, ST.array(OP.wireFine.mat(MT.Cu            , 1), OP.wireFine.mat(MT.Signalum, 1), OP.plateGemTiny.mat(MT.Si           , 1)), IL.Circuit_Part_Good         .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,  32, 16, ST.array(OP.wireFine.mat(MT.AnnealedCopper, 1), OP.wireFine.mat(MT.Signalum, 1), OP.plateGemTiny.mat(MT.Si           , 1)), IL.Circuit_Part_Good         .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,  32, 16, ST.array(OP.wireFine.mat(MT.Cu            , 1), OP.wireFine.mat(MT.RedAlloy, 1), OP.plateGemTiny.mat(MT.Si           , 1)), IL.Circuit_Part_Good         .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,  32, 16, ST.array(OP.wireFine.mat(MT.AnnealedCopper, 1), OP.wireFine.mat(MT.RedAlloy, 1), OP.plateGemTiny.mat(MT.Si           , 1)), IL.Circuit_Part_Good         .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,  32, 16, ST.array(OP.wireFine.mat(MT.Cu            , 1), OP.wireFine.mat(MT.Signalum, 1), OP.plateGemTiny.mat(MT.Ge           , 1)), IL.Circuit_Part_Good         .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,  32, 16, ST.array(OP.wireFine.mat(MT.AnnealedCopper, 1), OP.wireFine.mat(MT.Signalum, 1), OP.plateGemTiny.mat(MT.Ge           , 1)), IL.Circuit_Part_Good         .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,  32, 16, ST.array(OP.wireFine.mat(MT.Cu            , 1), OP.wireFine.mat(MT.RedAlloy, 1), OP.plateGemTiny.mat(MT.Ge           , 1)), IL.Circuit_Part_Good         .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,  32, 16, ST.array(OP.wireFine.mat(MT.AnnealedCopper, 1), OP.wireFine.mat(MT.RedAlloy, 1), OP.plateGemTiny.mat(MT.Ge           , 1)), IL.Circuit_Part_Good         .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,  32, 16, ST.array(OP.wireFine.mat(MT.Cu            , 1), OP.wireFine.mat(MT.Signalum, 1), OP.plateGemTiny.mat(MT.RedstoneAlloy, 1)), IL.Circuit_Part_Good         .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,  32, 16, ST.array(OP.wireFine.mat(MT.AnnealedCopper, 1), OP.wireFine.mat(MT.Signalum, 1), OP.plateGemTiny.mat(MT.RedstoneAlloy, 1)), IL.Circuit_Part_Good         .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,  32, 16, ST.array(OP.wireFine.mat(MT.Cu            , 1), OP.wireFine.mat(MT.RedAlloy, 1), OP.plateGemTiny.mat(MT.RedstoneAlloy, 1)), IL.Circuit_Part_Good         .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,  32, 16, ST.array(OP.wireFine.mat(MT.AnnealedCopper, 1), OP.wireFine.mat(MT.RedAlloy, 1), OP.plateGemTiny.mat(MT.RedstoneAlloy, 1)), IL.Circuit_Part_Good         .get(1));
		...
		RM.Assembler.addRecipeX(T, F, F, F, T, 128, 48, ST.array(OP.wireFine.mat(MT.Au            , 1), OP.wireFine.mat(MT.Signalum, 1), OP.plateGemTiny.mat(MT.RedstoneAlloy, 1)), IL.Circuit_Part_Elite        .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,128, 192, ST.array(OP.wireFine.mat(MT.Pt            , 1), OP.wireFine.mat(MT.Signalum, 1), OP.plateGemTiny.mat(MT.Si           , 1)), IL.Circuit_Part_Master       .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,128, 192, ST.array(OP.wireFine.mat(MT.Pt            , 1), OP.wireFine.mat(MT.Signalum, 1), OP.plateGemTiny.mat(MT.Ge           , 1)), IL.Circuit_Part_Master       .get(1));
		RM.Assembler.addRecipeX(T, F, F, F, T,128, 192, ST.array(OP.wireFine.mat(MT.Pt            , 1), OP.wireFine.mat(MT.Signalum, 1), OP.plateGemTiny.mat(MT.RedstoneAlloy, 1)), IL.Circuit_Part_Ultimate     .get(1));
		...
		RM.Assembler.addRecipe2(T, F, F, F, T, 16, 64, IL.Circuit_Plate_Signalum    .get(1), IL.Circuit_Part_Signalum   .get(4), IL.Circuit_Board_Signalum      .get(1));

		RM.Assembler.addRecipe2(T, F, F, F, T, 16, 64, IL.Circuit_Plate_HSLA        .get(1), IL.Circuit_Part_EnderPearl .get(4), IL.Circuit_Board_HSLA_Circuit  .get(1));
		RM.Assembler.addRecipe2(T, F, F, F, T, 16, 64, IL.Circuit_Plate_HSLA        .get(1), IL.Circuit_Part_EnderEye   .get(4), IL.Circuit_Board_Power_Module  .get(1));
		...
		RM.Assembler.addRecipe1(T, F, F, F, T,32, 64, IL.Circuit_Board_Signalum      .get(1), MT.Pb              .liquid(U, T), NF, IL.Circuit_Signalum      .get(1));
		RM.Assembler.addRecipe1(T, F, F, F, T,32, 64, IL.Circuit_Board_Signalum      .get(1), MT.Sn              .liquid(U, T), NF, IL.Circuit_Signalum      .get(1));
		RM.Assembler.addRecipe1(T, F, F, F, T,32, 64, IL.Circuit_Board_Signalum      .get(1), MT.SolderingAlloy  .liquid(U, T), NF, IL.Circuit_Signalum      .get(1));

		RM.Assembler.addRecipe1(T, F, F, F, T,32, 64, IL.Circuit_Board_BC_Redstone   .get(1), MT.SolderingAlloy  .liquid(U, T), NF, IL.Circuit_BC_Redstone   .get(1));
		RM.Assembler.addRecipe1(T, F, F, F, T,32, 64, IL.Circuit_Board_BC_Iron       .get(1), MT.SolderingAlloy  .liquid(U, T), NF, IL.Circuit_BC_Iron       .get(1));
		RM.Assembler.addRecipe1(T, F, F, F, T,32, 64, IL.Circuit_Board_BC_Gold       .get(1), MT.SolderingAlloy  .liquid(U, T), NF, IL.Circuit_BC_Gold       .get(1));
		RM.Assembler.addRecipe1(T, F, F, F, T,32, 64, IL.Circuit_Board_BC_Diamond    .get(1), MT.SolderingAlloy  .liquid(U, T), NF, IL.Circuit_BC_Diamond    .get(1));
		RM.Assembler.addRecipe1(T, F, F, F, T,32, 64, IL.Circuit_Board_BC_Ender      .get(1), MT.SolderingAlloy  .liquid(U, T), NF, IL.Circuit_BC_Ender      .get(1));
		RM.Assembler.addRecipe1(T, F, F, F, T,32, 64, IL.Circuit_Board_BC_Quartz     .get(1), MT.SolderingAlloy  .liquid(U, T), NF, IL.Circuit_BC_Quartz     .get(1));
		RM.Assembler.addRecipe1(T, F, F, F, T,32, 64, IL.Circuit_Board_BC_Comparator .get(1), MT.SolderingAlloy  .liquid(U, T), NF, IL.Circuit_BC_Comparator .get(1));
		RM.Assembler.addRecipe1(T, F, F, F, T,32, 64, IL.Circuit_Board_BC_Emerald    .get(1), MT.SolderingAlloy  .liquid(U, T), NF, IL.Circuit_BC_Emerald    .get(1));
		...
		RM.Assembler.addRecipe2(T, F, F, F, T, 480, 144, IL.Processor_Crystal_Empty.get(1), IL.Circuit_Crystal_Emerald .get(1), IL.Processor_Crystal_Emerald .get(1));
		RM.Assembler.addRecipe2(T, F, F, F, T, 480, 144, IL.Processor_Crystal_Empty.get(1), IL.Circuit_Crystal_Sapphire.get(1), IL.Processor_Crystal_Sapphire.get(1));
