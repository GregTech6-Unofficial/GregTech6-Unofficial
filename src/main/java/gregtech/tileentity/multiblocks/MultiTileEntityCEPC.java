...
public class MultiTileEntityCEPC extends TileEntityBase10MultiBlockMachine {
    ...
    static {
        LH.add("gt.tooltip.multiblock.cepc.1", "For Construction Instructions read the Manual or the GUI.");
        LH.add("gt.tooltip.multiblock.cepc.2", "144 Superconducting Coils, 576 Regular Osmiridium Walls, 50 Ventilation Units.");
        LH.add("gt.tooltip.multiblock.cepc.3", "36 Regular Stainless Steel Walls, 53 Galvanized Steel Walls.");
        LH.add("gt.tooltip.multiblock.cepc.4", "3 Versatile, 12 Logic and 12 Control Quadcore Processing Units.");
        LH.add("gt.tooltip.multiblock.cepc.5", "Input energy for start.Then for process");
        LH.add("gt.tooltip.multiblock.cepc.6", "Electric power Input at the 'Glass' Ring");
        LH.add("gt.tooltip.multiblock.cepc.7", "Items and Fluids are handeled at the normal Walls");
    }

    @Override
    public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
        aList.add(Chat.CYAN  + LH.get(LH.STRUCTURE) + ":");
        aList.add(Chat.WHITE + LH.get("gt.tooltip.multiblock.cepc.1"));
        aList.add(Chat.WHITE + LH.get("gt.tooltip.multiblock.cepc.2"));
        aList.add(Chat.WHITE + LH.get("gt.tooltip.multiblock.cepc.3"));
        aList.add(Chat.WHITE + LH.get("gt.tooltip.multiblock.cepc.4"));
        aList.add(Chat.WHITE + LH.get("gt.tooltip.multiblock.cepc.5"));
        aList.add(Chat.WHITE + LH.get("gt.tooltip.multiblock.cepc.6"));
        aList.add(Chat.WHITE + LH.get("gt.tooltip.multiblock.cepc.7"));
    ...
    @Override public String getTileEntityName() {return "gt.multitileentity.multiblock.cepc";}
}
