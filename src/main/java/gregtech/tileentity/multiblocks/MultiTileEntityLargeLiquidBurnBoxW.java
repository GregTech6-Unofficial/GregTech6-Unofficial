 ...
 */
public class MultiTileEntityLargeLiquidBurnBoxW extends TileEntityBase10MultiBlockBase implements IFluidHandler, ITileEntityRunningActively, ITileEntityEnergy, IMultiBlockFluidHandler, IMultiBlockEnergy {
	...
	static {
		LH.add("gt.tooltip.multiblock.largeliquidburnboxw.1", "3x3 Ring of 8 Heat Transmitters with Dense Tungsten Wall inside");
		LH.add("gt.tooltip.multiblock.largeliquidburnboxw.2", "3x3 Ring of 8 Dense Tungsten Walls with Main inside");
		LH.add("gt.tooltip.multiblock.largeliquidburnboxw.3", "Energy Output split over the 8 Heat Transmitters (Top)");
		LH.add("gt.tooltip.multiblock.largeliquidburnboxw.4", "Input at Bottom Layer, Fluid Output at Main Block");
	}
	
	@Override
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get(LH.STRUCTURE) + ":");
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.largeliquidburnboxw.1"));
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.largeliquidburnboxw.2"));
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.largeliquidburnboxw.3"));
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.largeliquidburnboxw.4"));
	...
	@Override public String getTileEntityName() {return "gt.multitileentity.multiblock.largeliquidbrunboxw";}
}
