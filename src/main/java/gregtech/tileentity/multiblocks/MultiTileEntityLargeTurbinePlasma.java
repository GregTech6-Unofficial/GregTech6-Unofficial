 ...
 */
public class MultiTileEntityLargeTurbinePlasma extends MultiTileEntityLargeTurbine {
	...
	public RecipeMap mRecipes = FM.Plasma;
	...
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		...
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.plasmaturbine.1"));
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.plasmaturbine.2"));
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.plasmaturbine.3"));
		aList.add(Chat.ORANGE   + LH.get("gt.tooltip.multiblock.plasmaturbine.4"));
	...
	@Override public String getTileEntityName() {return "gt.multitileentity.multiblock.turbine.plasma";}
}
