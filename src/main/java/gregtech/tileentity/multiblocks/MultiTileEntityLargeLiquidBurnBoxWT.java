 ...
 */
public class MultiTileEntityLargeLiquidBurnBoxWT extends TileEntityBase10MultiBlockBase implements IFluidHandler, ITileEntityRunningActively, ITileEntityEnergy, IMultiBlockFluidHandler, IMultiBlockEnergy {
	...
	static {
		LH.add("gt.tooltip.multiblock.largeliquidburnboxwt.1", "3x3 Ring of 8 Heat Transmitters with Dense Tungstensteel Wall inside");
		LH.add("gt.tooltip.multiblock.largeliquidburnboxwt.2", "3x3 Ring of 8 Dense Tungstensteel Walls with Main inside");
		LH.add("gt.tooltip.multiblock.largeliquidburnboxwt.3", "Energy Output split over the 8 Heat Transmitters (Top)");
		LH.add("gt.tooltip.multiblock.largeliquidburnboxwt.4", "Input at Bottom Layer, Fluid Output at Main Block");
	}
	
	@Override
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get(LH.STRUCTURE) + ":");
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.largeliquidburnboxwt.1"));
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.largeliquidburnboxwt.2"));
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.largeliquidburnboxwt.3"));
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.largeliquidburnboxwt.4"));
	...
	@Override public String getTileEntityName() {return "gt.multitileentity.multiblock.largeliquidbrunboxwt";}
}
