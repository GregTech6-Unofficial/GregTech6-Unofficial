 ...
 */
public class MultiTileEntityLargeTurbineEngine extends MultiTileEntityLargeTurbine {
	...
	static {
		LH.add("gt.tooltip.multiblock.engineturbine.1", "3x3x4 of the Block you crafted this one with");
		LH.add("gt.tooltip.multiblock.engineturbine.2", "Main centered on the 3x3 facing outwards");
		LH.add("gt.tooltip.multiblock.engineturbine.3", "Input only possible at frontal 3x3");
		LH.add("gt.tooltip.multiblock.engineturbine.4", "Exhaust Gas has to be removed!");
	}
	
	@Override
	public void addToolTips(List<String> aList, ItemStack aStack, boolean aF3_H) {
		aList.add(Chat.CYAN     + LH.get(LH.STRUCTURE) + ":");
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.engineturbine.1"));
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.engineturbine.2"));
		aList.add(Chat.WHITE    + LH.get("gt.tooltip.multiblock.engineturbine.3"));
		aList.add(Chat.ORANGE   + LH.get("gt.tooltip.multiblock.engineturbine.4"));
	...
	@Override public String getTileEntityName() {return "gt.multitileentity.multiblock.turbine.engine";}
}
