...
public class Loader_Worldgen implements Runnable {
	...
	public void run() {
		...
		, new StoneLayerOres(MT.Cu                      , U12, 32, 80, BIOMES_MOUNTAINS)
		, new StoneLayerOres(MT.OREMATS.Cassiterite     , U16, 40, 80)
		, new StoneLayerOres(MT.OREMATS.Stannite        , U16, 40, 82)
		, new StoneLayerOres(MT.OREMATS.Kesterite       , U16, 40, 82)
		));
		...
		new WorldgenOresLarge("ore.large.pitchblende"       , T, T,  10,  40,     40,   3,  16, MT.OREMATS.Pitchblende      , MT.OREMATS.Pitchblende    , MT.OREMATS.Uraninite              , MT.OREMATS.Uraninite              , ORE_OVERWORLD, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_NETHER, ORE_MARS, ORE_PLANETS);
		new WorldgenOresLarge("ore.large.monazite"          , T, T,  20,  40,     30,   3,  16, MT.OREMATS.Bastnasite       , MT.OREMATS.Bastnasite     , MT.Monazite                       , MT.Nd                             , ORE_OVERWORLD, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_NETHER, ORE_MARS, ORE_PLANETS);
		new WorldgenOresLarge("ore.large.diamond"           , T, T,   5,  20,     40,   2,  16, MT.Graphite                 , MT.Graphite               , MT.Diamond                        , MT.Graphite                       , ORE_OVERWORLD, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_NETHER, ORE_MARS, ORE_PLANETS);
		new WorldgenOresLarge("ore.large.galena"            , T, T,  30,  60,     40,   5,  16, MT.OREMATS.Galena           , MT.OREMATS.Galena         , MT.Ag                             , MT.Pb                             , ORE_OVERWORLD, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, ORE_NETHER, ORE_PLANETS);
		...
		new WorldgenOresLarge("ore.large.olivine"           , T, T,  10,  40,     60,   3,  16, MT.OREMATS.Bentonite        , MT.OREMATS.Magnesite      , MT.Olivine                        , MT.OREMATS.Glauconite             , ORE_OVERWORLD, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_NETHER, ORE_MARS, ORE_PLANETS, ORE_MOON, ORE_END);
		new WorldgenOresLarge("ore.large.gold"              , T, T,  20,  30,      5,   3,  16, MT.Pyrite                   , MT.OREMATS.Chalcopyrite   , MT.OREMATS.Arsenopyrite           , MT.Au                             , ORE_OVERWORLD, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_NETHER, ORE_MARS, ORE_PLANETS, ORE_END, ORE_ASTEROIDS);
