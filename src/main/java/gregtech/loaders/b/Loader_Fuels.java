...
public class Loader_Fuels implements Runnable {
	...
	public void run() {
		...
		FM.Burn         .addRecipe0(T, - 64,  4, FL.make("ethene", 1)                          , FL.make("carbondioxide", 1), ZL_IS);
		FM.Gas          .addRecipe0(T, - 64,  5, FL.make("ethene", 1)                          , FL.Water.make(1), FL.make("carbondioxide", 1));
