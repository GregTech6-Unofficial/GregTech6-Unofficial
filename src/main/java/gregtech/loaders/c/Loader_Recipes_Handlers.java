...
public class Loader_Recipes_Handlers implements Runnable {
	...
	public void run() {
		...
		RM.Wiremill             .add(new RecipeMapHandlerPrefix(ingot                           , 1, NF,  64, 0,   128, NF, wireLPGt01        , 2, NI, NI, T, F, F, new And(ANTIMATTER.NOT, COATED.NOT, SMITHABLE)));
		RM.Wiremill             .add(new RecipeMapHandlerPrefix(compressed                      , 1, NF,  64, 0,   128, NF, wireLPGt01        , 2, NI, NI, T, F, F, new And(ANTIMATTER.NOT, COATED.NOT, SMITHABLE)));
		...
		RM.LaserCutter  .add(new RecipeMapHandlerPrefix(blockSolid         , 1, NF,  16,tMultiplier[i] * 7 * 32,     0, NF, plate        , 9, NI, NI, F, F, F, ANTIMATTER.NOT));
