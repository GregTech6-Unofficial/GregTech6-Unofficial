...
public class Loader_Recipes_Extruder implements Runnable {
	...
	public void run() {
		...
		for (OreDictMaterial tMaterial : new OreDictMaterial[] {MT.Zr, MT.WaxBee, MT.WaxPlant, MT.WaxParaffin, MT.WaxRefractory, MT.WaxMagic, MT.WaxAmnesic, MT.Fe, MT.WroughtIron, MT.Glass, MT.Sn, MT.TinAlloy, MT.Plastic}) {
			...
			for (ItemStack tStack : new ArrayListNoNulls<ItemStack>(F, OP.scrapGt.mat(tMaterial, 9), OP.round.mat(tMaterial, 9), OP.nugget.mat(tMaterial, 9), OP.chunkGt.mat(tMaterial, 4), OP.ingot.mat(tMaterial, 1), OP.gem.mat(tMaterial, 1), OP.gemFlawed.mat(tMaterial, 2), OP.gemChipped.mat(tMaterial, 4), OP.bolt.mat(tMaterial, 8), OP.ring.mat(tMaterial, 4), OP.stick.mat(tMaterial, 2), OP.stickLong.mat(tMaterial, 1), OP.casingSmall.mat(tMaterial, 2), OP.gearGtSmall.mat(tMaterial, 1), OP.wireGt01.mat(tMaterial, 2), OP.wireGt02.mat(tMaterial, 1), OP.plateTiny.mat(tMaterial, 9), OP.plateGemTiny.mat(tMaterial, 9), OP.plate.mat(tMaterial, 1), OP.plateGem.mat(tMaterial, 1))) {
