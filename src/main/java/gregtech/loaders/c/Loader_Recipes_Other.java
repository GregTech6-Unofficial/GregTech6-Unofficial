...
//      RM.Bath             .addRecipe2(T,  0,  128, ST.make(Items.paper, 9, W), ST.tag(9), FL.Glue.make(1000), NF, plateDense.mat(MT.Paper, 1));
		...
		RM.Fusion.addRecipe1(T, 2048,  256, ST.tag(2), FL.array(MT.H     .gas   (U  , T), MT.C_13.liquid(U  , T)), FL.array(MT.N     .plasma(  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*3000L*10L);
		...
		RM.Fusion.addRecipe1(T, 2048,  264, ST.tag(2), FL.array(MT.H     .gas   (U*2, T), MT.O   .gas   (U  , T)), FL.array(MT.He    .gas   (  U2, F), MT.F     .gas   (  U2, F), MT.N     .plasma   (  U2, F)                        ), ZL_IS                ).setSpecialNumber( 2000L*3000L*10L);
