...
//      RM.Bath             .addRecipe2(T,  0,  128, ST.make(Items.paper, 9, W), ST.tag(9), FL.Glue.make(1000), NF, plateDense.mat(MT.Paper, 1));
		...
		RM.Fusion.addRecipe1(T, 2048,  144, ST.tag(1), FL.array(MT.He_3  .gas   (U*2, T)                        ), FL.array(MT.He    .plasma(  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*3000L*10L);
		...
		RM.Fusion.addRecipe1(T, 2048,  234, ST.tag(2), FL.array(MT.H     .gas   (U  , T), MT.B_11.liquid(U  , T)), FL.array(MT.He    .plasma(3*U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*3000L*10L);
		...
		RM.Fusion.addRecipe1(T, 4096,  256, ST.tag(2), FL.array(MT.H     .gas   (U  , T), MT.C_13.liquid(U  , T)), FL.array(MT.N     .plasma(  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
		...
		RM.Fusion.addRecipe1(T, 4096,  276, ST.tag(2), FL.array(MT.H     .gas   (U*2, T), MT.O   .gas   (U  , T)), FL.array(MT.He    .gas   (  U2, F), MT.F     .gas   (  U2, F), MT.N     .plasma   (  U2, F)                        ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
		...
		RM.Fusion.addRecipe1(T, 2048,  768, ST.tag(2), FL.array(MT.T     .gas   (U  , T), MT.He_3.gas   (U  , T)), FL.array(MT.He    .gas   (3*U4, F), MT.D     .gas   (  U4, F)                                                      ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
