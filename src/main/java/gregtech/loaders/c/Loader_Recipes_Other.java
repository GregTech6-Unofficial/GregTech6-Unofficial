...
//      RM.Bath             .addRecipe2(T,  0,  128, ST.make(Items.paper, 9, W), ST.tag(9), FL.Glue.make(1000), NF, plateDense.mat(MT.Paper, 1));
        ...
        */
        ...
        RM.Assembler.addRecipeX(T, 64, 40, ST.array(pipeTiny.mat(MT.TungstenSteel, 1), wireGt01.mat(MT.Nq, 1), IL.Electric_Pump_LV.get(2)), FL.array(FL.Nitrogen.make(1000)), ZL_FS, wireGt01.mat(Superconductor, 1));
        RM.Assembler.addRecipeX(T, 64, 40, ST.array(pipeTiny.mat(MT.TungstenSteel, 1), wireGt01.mat(MT.Nq, 1), IL.Electric_Pump_LV.get(2)), FL.array(FL.Helium.make(1000)), ZL_FS, wireGt01.mat(Superconductor, 1));
        RM.Assembler.addRecipeX(T, 64, 40, ST.array(pipeTiny.mat(MT.TungstenSteel, 1), wireGt01.mat(MT.Nq, 1), IL.Electric_Pump_LV.get(2)), FL.array(FL.Hydrogen.make(1000)), ZL_FS, wireGt01.mat(Superconductor, 1));
