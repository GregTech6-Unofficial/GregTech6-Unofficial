...
//      RM.Bath             .addRecipe2(T,  0,  128, ST.make(Items.paper, 9, W), ST.tag(9), FL.Glue.make(1000), NF, plateDense.mat(MT.Paper, 1));
		...
		RM.Fusion.addRecipe1(T, 8192,  384, ST.tag(1), FL.array(MT.D     .gas   (U*2, T)                        ), FL.array(MT.He_3  .gas   (  U2, F), MT.T     .gas   (  U2, F)                                                      ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  384, ST.tag(1), FL.array(MT.T     .gas   (U*2, T)                        ), FL.array(MT.He    .gas   (  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  384, ST.tag(1), FL.array(MT.He_3  .gas   (U*2, T)                        ), FL.array(MT.He    .gas   (  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 2048,  384, ST.tag(1), FL.array(MT.He    .gas   (U*2, T)                        ), FL.array(MT.Be_8  .liquid(  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 2048,  256, ST.tag(1), FL.array(MT.Be_8  .liquid(U*2, T)                        ), FL.array(MT.O     .gas   (  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  546, ST.tag(2), FL.array(MT.H     .gas   (U  , T), MT.B_11.liquid(U  , T)), FL.array(MT.He    .gas   (3*U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  384, ST.tag(2), FL.array(MT.H     .gas   (U  , T), MT.C   .liquid(U  , T)), FL.array(MT.C_13  .liquid(  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  384, ST.tag(2), FL.array(MT.H     .gas   (U  , T), MT.C_13.liquid(U  , T)), FL.array(MT.N     .gas   (  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  576, ST.tag(2), FL.array(MT.H     .gas   (U*2, T), MT.N   .gas   (U  , T)), FL.array(MT.He    .gas   (  U2, F), MT.C     .liquid(  U2, F), MT.O     .gas   (  U2, F)                           ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  455, ST.tag(2), FL.array(MT.H     .gas   (U*2, T), MT.O   .gas   (U  , T)), FL.array(MT.He    .gas   (  U2, F), MT.F     .gas   (  U2, F), MT.N     .gas   (  U2, F)                           ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  768, ST.tag(2), FL.array(MT.D     .gas   (U  , T), MT.T   .gas   (U  , T)), FL.array(MT.He    .gas   (  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  768, ST.tag(2), FL.array(MT.D     .gas   (U  , T), MT.He_3.gas   (U  , T)), FL.array(MT.He    .gas   (  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  768, ST.tag(2), FL.array(MT.T     .gas   (U  , T), MT.He_3.gas   (U  , T)), FL.array(MT.He    .gas   (3*U4, F), MT.D     .gas   (  U4, F)                                                      ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  384, ST.tag(2), FL.array(MT.D     .gas   (U  , T), MT.Li_6.liquid(U  , T)), FL.array(MT.He    .gas   (3*U8, F), MT.He_3  .gas   (  U8, F), MT.Li    .liquid(  U8, F), MT.Be_7  .liquid(  U8, F)), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  576, ST.tag(2), FL.array(MT.He_3  .gas   (U  , T), MT.Li_6.liquid(U  , T)), FL.array(MT.He    .gas   (2*U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  576, ST.tag(2), FL.array(MT.He    .gas   (U  , T), MT.Be_8.liquid(U  , T)), FL.array(MT.C     .liquid(  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T, 8192,  576, ST.tag(2), FL.array(MT.He    .gas   (U  , T), MT.C   .liquid(U  , T)), FL.array(MT.O     .gas   (  U , F)                                                                                 ), ZL_IS                ).setSpecialNumber( 2000L*2000L*2L);
		RM.Fusion.addRecipe1(T,16384, 1024, ST.tag(2), FL.array(MT.Ad    .liquid(U  , T), MT.Be_7.liquid(U  , T)), FL.array(MT.W     .liquid(  U , F), MT.He    .gas   (16*U, F), MT.He_3  .gas   (24*U, F), MT.T     .gas   (24*U, F)), OP.dust.mat(MT.Vb, 1)).setSpecialNumber(60000L*2000L*2L);
