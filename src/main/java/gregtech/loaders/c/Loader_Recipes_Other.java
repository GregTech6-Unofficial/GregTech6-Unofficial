...
//      RM.Bath             .addRecipe2(T,  0,  128, ST.make(Items.paper, 9, W), ST.tag(9), FL.Glue.make(1000), NF, plateDense.mat(MT.Paper, 1));
		...
		RM.Fusion.addRecipe1(T, 2048,  384, ST.tag(1), FL.array(MT.D   .gas   (U*2, T)                        ), FL.array(MT.He_3  .gas   (  U2*1, F), MT.T   .gas   (U2*1, F)                                                     ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
		RM.Fusion.addRecipe1(T, 2048,  384, ST.tag(1), FL.array(MT.T   .gas   (U*2, T)                        ), FL.array(MT.He    .gas   (  U*1 , F)                                                                                             ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
		RM.Fusion.addRecipe1(T, 2048,  112, ST.tag(1), FL.array(MT.He_3.gas   (U*2, T)                        ), FL.array(MT.He    .plasma(  U*1 , F)                                                                                             ), ZL_IS                ).setSpecialNumber( 2000L*3000L*10L);
		RM.Fusion.addRecipe1(T, 2048,  384, ST.tag(1), FL.array(MT.He  .gas   (U*2, T)                        ), FL.array(MT.Be_8  .liquid(  U*1 , F)                                                                                             ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
		RM.Fusion.addRecipe1(T, 2048,  234, ST.tag(1), FL.array(MT.Be_8.liquid(U*2, T)                        ), FL.array(MT.O     .gas   (  U*1 , F)                                                                                             ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
		RM.Fusion.addRecipe1(T, 2048,  276, ST.tag(2), FL.array(MT.H   .gas   (U*1, T), MT.B_11.liquid(U  , T)), FL.array(MT.He    .plasma(  U*3 , F)                                                                                             ), ZL_IS                ).setSpecialNumber( 2000L*3000L*10L);
		RM.Fusion.addRecipe1(T, 2048,  384, ST.tag(2), FL.array(MT.H   .gas   (U*1, T), MT.C   .liquid(U  , T)), FL.array(MT.C_13  .liquid(  U*1 , F)                                                                                             ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
		RM.Fusion.addRecipe1(T, 4096,  128, ST.tag(2), FL.array(MT.H   .gas   (U*1, T), MT.C_13.liquid(U  , T)), FL.array(MT.N     .plasma(  U*1 , F)                                                                                             ), ZL_IS                ).setSpecialNumber( 2000L*3000L*10L);
		RM.Fusion.addRecipe1(T, 2048,  576, ST.tag(2), FL.array(MT.H   .gas   (U*2, T), MT.N   .gas   (U  , T)), FL.array(MT.He    .gas   (  U2*1, F), MT.C   .liquid(U2*1, F), MT.O     .gas   (U2*1, F)          ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
		RM.Fusion.addRecipe1(T, 4096,   96, ST.tag(2), FL.array(MT.H   .gas   (U*2, T), MT.O   .gas   (U  , T)), FL.array(MT.He    .gas   (  U2*1, F), MT.F   .gas   (U2*1, F), MT.N     .plasma(U2*1, F)          ), ZL_IS                ).setSpecialNumber( 2000L*3000L*10L);
		RM.Fusion.addRecipe1(T, 2048,  768, ST.tag(2), FL.array(MT.D   .gas   (U*1, T), MT.T   .gas   (U  , T)), FL.array(MT.He    .gas   (  U*1 , F)                                                                                             ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
		RM.Fusion.addRecipe1(T, 2048,  768, ST.tag(2), FL.array(MT.D   .gas   (U*1, T), MT.He_3.gas   (U  , T)), FL.array(MT.He    .gas   (  U*1 , F)                                                                                             ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
		RM.Fusion.addRecipe1(T, 2048,  238, ST.tag(2), FL.array(MT.T   .gas   (U*1, T), MT.He_3.gas   (U  , T)), FL.array(MT.He    .plasma(  U4*3, F), MT.D   .gas   (U4*1, F)                                                     ), ZL_IS                ).setSpecialNumber( 2000L*3000L*10L);
		RM.Fusion.addRecipe1(T, 2048,  196, ST.tag(2), FL.array(MT.He_3.gas   (U*1, T), MT.Li_6.liquid(U  , T)), FL.array(MT.He    .plasma(  U*2 , F)                                                                                             ), ZL_IS                ).setSpecialNumber( 2000L*3000L*10L);
		RM.Fusion.addRecipe1(T, 2048,  576, ST.tag(2), FL.array(MT.He  .gas   (U*1, T), MT.Be_8.liquid(U  , T)), FL.array(MT.C     .liquid(  U*1 , F)                                                                                             ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
		RM.Fusion.addRecipe1(T, 2048,  576, ST.tag(2), FL.array(MT.He  .gas   (U*1, T), MT.C   .liquid(U  , T)), FL.array(MT.O     .gas   (  U*1 , F)                                                                                             ), ZL_IS                ).setSpecialNumber( 2000L*20000L*1L);
        RM.Fusion.addRecipe1(T, 2048,  384, ST.tag(2), FL.array(MT.D   .gas   (U*1, T), MT.Li_6.liquid(U  , T)), FL.array(MT.He    .gas   (  U8*3, F), MT.He_3.gas   (U8*1, F), MT.Li    .liquid(U8*1, F), MT.Be_7  .liquid(U8*1, F)), ZL_IS                          ).setSpecialNumber( 2000L*20000L*1L);
        RM.Fusion.addRecipe1(T,16384, 1024, ST.tag(2), FL.array(MT.Ad  .liquid(U*1, T), MT.Be_7.liquid(U  , T)), FL.array(MT.W     .liquid(  U*1 , F), MT.He  .gas   (16*U, F), MT.He_3  .gas   (U*24, F), MT.T     .gas   (U*24, F)), OP.dust.mat(MT.Vb, 1)).setSpecialNumber(60000L*20000L*12L);
